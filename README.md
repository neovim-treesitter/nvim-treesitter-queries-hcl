...
[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-hcl/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-hcl/actions/workflows/validate.yml)

Neovim tree-sitter queries for **hcl**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-hcl",
...
- [ ] Changes are scoped to `hcl` — do not include files for other languages
